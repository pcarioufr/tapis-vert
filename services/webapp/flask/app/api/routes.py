from . import api  # Import the Blueprint from __init__.py
...
@api.route("/v1/r/<room_id>", methods=['GET', 'DELETE'])
...
@api.route("/v1/r/<room_id>/round", methods=['POST'])
...
@api.route("/v1/<room_id>/users/<user_id>", methods=['POST', 'DELETE'])
...
@api.route("/v1/users/<user_id>", methods=['POST', 'DELETE', 'GET', 'PUT'])
...
@api.route('/v1/qrcode', methods=['GET'])
def qr_code():
